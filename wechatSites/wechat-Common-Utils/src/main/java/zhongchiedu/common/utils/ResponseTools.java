...
public class ResponseTools {
	...
	private static final Logger LOG = LoggerFactory.getLogger(ResponseTools.class);
	...
	public static void responsePicture(HttpServletResponse response, InputStream is) {
