...
//		String savePath = uploadPath + "attached/";
//
//		// 文件保存目录URL
//		//String saveUrl = request.getContextPath() + "/attached/";
//		String saveUrl = rootPath+"/"+uploadPath + "attached/";
//
//		// 定义允许上传的文件扩展名
...
//		String rootPath = rootPATH + "attached/";
//		//String rootPath = application.getRealPath("/") + "attached/";
//		// 根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
//	//	String rootUrl = request.getContextPath() + "/attached/";
//			String rootUrl = rootPath+"/"+uploadPath + "attached/";
//		// 图片扩展名
